    ...
    def shiftRow(self, param1, param2):
        ...
        while _loc3_ < 4:
            if param2 == 'encrypt':
                ...
                param1[_loc3_] = self.cyclicShiftLeft(
                    param1[_loc3_], self.Nb - self.shiftOffsets[self.Nb][_loc3_])
        ...
        while _loc5_ < self.Nb:
            ...
            while _loc4_ < 4:
                ...
                if param2 == "encrypt":
                    ...
                    _loc3_[_loc4_] = self.mult_GF256(param1[_loc4_][_loc5_],
                                                     14) ^ self.mult_GF256(param1[(_loc4_ + 1) % 4][_loc5_],
                                                                           11) ^ self.mult_GF256(param1[(_loc4_ + 2) % 4][_loc5_],
                                                                                                 13) ^ self.mult_GF256(param1[(_loc4_ + 3) % 4][_loc5_],
                                                                                                                       9)
                _loc4_ += 1
