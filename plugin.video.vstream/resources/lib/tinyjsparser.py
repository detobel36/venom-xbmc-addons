...
# if(!_0x45ae41[_0x5949('28')](_0x5949('9'),document)||!(!(typeof
...
class JsParser(object):
    ...
    # Syntax > aaaaaa.bbbbbb(cccccc) ou bbbb(cccc) ou "aaaa".bb(ccc) ou
    # aa[bb](cc)
    def FonctionParser(
            self,
            vars,
                ...
                if name == 'if':
                    ...
                    if self.option_ForceTest:
                        try:
                            ...
                            # thx to come every day, to help me to find bug on
                            # this code
