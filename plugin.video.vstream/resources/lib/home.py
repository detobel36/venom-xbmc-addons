...
class Home:
    ...
    def showSearchText(self):
        ...
        sSearchText = gui.showKeyBoard(heading=self.addons.VSlang(30076))
        if not sSearchText:
            return False
    ...
    def showMovies(self):
        ...
        # gui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30120), self.addons.VSlang(30160)), 'hd.png', output_parameter_handler)
        ...
        # gui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30120), self.addons.VSlang(30103)), 'comments.png', output_parameter_handler)
        ...
        # gui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30120), self.addons.VSlang(30107)), 'vf.png', output_parameter_handler)
    ...
    def showSeries(self):
        ...
        # gui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30121), self.addons.VSlang(30107)), 'vf.png', output_parameter_handler)
    ...
    def showDirect(self):
        ...
        gui.addDir(
            SITE_IDENTIFIER,
            'showMenuTV',
            self.addons.VSlang(30115),
            'tv.png',
            output_parameter_handler)
        gui.addDir(
            'freebox',
            'showMenuMusic',
            self.addons.VSlang(30203),
            'music.png',
            output_parameter_handler)
        gui.setEndOfDirectory()
    ...
    def showMenuTV(self):
        ...
        gui.addDir(
            ...
            'films.png',
            output_parameter_handler)
        # gui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30138), self.addons.VSlang(30113)), 'host.png', output_parameter_handler)
    ...
    def showHistory(self):
        ...
        for match in row:
            ...
            try:
                ...
                oGuiElement.setTitle('- ' + str(title, 'utf-8'))
    ...
    def showHostDirect(self):  # fonction de recherche
        gui = Gui()
        sUrl = gui.showKeyBoard(heading=self.addons.VSlang(30045))
        if (sUrl):
            ...
            if (oHoster):
                ...
                HosterGui().showHoster(gui, oHoster, sUrl, '')
