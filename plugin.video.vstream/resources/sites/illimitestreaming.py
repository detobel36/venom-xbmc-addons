...
def showNetwork():
    ...
    output_parameter_handler.addParameter('sTmdbId', 1628)    # Utilisé par TMDB
    oGui.addNetwork(SITE_IDENTIFIER, SERIE_ARTE[1], 'Séries (Arte)', 'host.png', output_parameter_handler)
