...
def showMoviesYears():
    ...
    for i in reversed(xrange(1921, 2019)):
        ...
        output_parameter_handler.addParameter(
            'siteUrl', URL_MAIN + 'films-produit-en-' + Year)
        gui.addDir(
            SITE_IDENTIFIER,
            'showMovies',
            Year,
...
def showSeriesYears():
    ...
    for i in reversed(xrange(1940, 2019)):
        ...
        output_parameter_handler = OutputParameterHandler()
        output_parameter_handler.addParameter(
            'siteUrl', URL_MAIN + 'series-produit-en-' + Year)
        gui.addDir(
            SITE_IDENTIFIER,
            'showMovies',
            Year,
...
def showAnimsYears():
    ...
    for i in reversed(xrange(1969, 2019)):
        ...
        output_parameter_handler = OutputParameterHandler()
        output_parameter_handler.addParameter(
            'siteUrl', URL_MAIN + 'animes-produit-en-' + Year)
        gui.addDir(
            SITE_IDENTIFIER,
            'showMovies',
            Year,
        ...
        for aEntry in aResult[1]:
            ...
            if aEntry[0]:
                ...
                if 'aison' in sMovieTitle:
                    ...
                    title = sMovieTitle + ' S' + SaisonNum + aEntry[2]
...
def showLinks():
    ...
    if aResult[0]:
        for aEntry in aResult[1]:
            ...
            if sUrl.endswith(
                    '&c=') or '?p=0&c=' in sUrl:  # vide ou redirection
                continue
