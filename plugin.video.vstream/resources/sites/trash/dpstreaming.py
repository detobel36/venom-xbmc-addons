...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSeriesSearch', 'Recherche', 'search.png', output_parameter_handler)
...
def showGenres():
    ...
    for sTitle, sUrl in liste:
        output_parameter_handler.addParameter('siteUrl', URL_MAIN + 'serie-category/series/' + sUrl + '/')
...
def showMovies(sSearch=''):
    ...
    if aResult[0]:
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addTV(SITE_IDENTIFIER, 'showSeries', sTitle, '', sThumb, sDesc, output_parameter_handler)
...
def showLinks():
    ...
    if aResult[0]:
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addLink(SITE_IDENTIFIER, 'serieHosters', sDisplayTitle, sThumb, sDesc, output_parameter_handler)
