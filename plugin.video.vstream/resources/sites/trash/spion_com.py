            ...
            if (sCat != 'Image'):
                ...
                if (SPION_CENSURE):
                    if (sCat == 'NSFW') or (sCat == 'Trash'):
                        sPoster = LOGO_CSA
                        oGui.addMisc(SITE_IDENTIFIER, 'showCensure', sTitle, '', sPoster, '', output_parameter_handler)
                    else:
                        oGui.addMisc(SITE_IDENTIFIER, 'showHosters', sTitle, '', sPoster, '', output_parameter_handler)
                else:
                    oGui.addMisc(SITE_IDENTIFIER, 'showHosters', sTitle, '', sPoster, '', output_parameter_handler)
