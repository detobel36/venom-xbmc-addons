...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSearch', 'Recherche Films & Series', 'search.png', output_parameter_handler)
    ...
    oGui.addDir(SITE_IDENTIFIER, SERIE_GENRES[1], 'Série (Genres)', 'genres.png', output_parameter_handler)

    output_parameter_handler.addParameter('siteUrl', SERIE_VF[0])
    oGui.addDir(SITE_IDENTIFIER, SERIE_VF[1], 'Séries (VF)', 'vf.png', output_parameter_handler)

    output_parameter_handler.addParameter('siteUrl', SERIE_VOSTFR[0])
    oGui.addDir(SITE_IDENTIFIER, SERIE_VOSTFR[1], 'Série (VOSTFR)', 'vostfr.png', output_parameter_handler)
...
def showEpisodes():
    ...
    if aResult[0]:
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addEpisode(SITE_IDENTIFIER, 'showSerieLinks', sTitle, '', sThumb, sDesc, output_parameter_handler)
...
def showSerieLinks():
    ...
    if aResult[0]:
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addLink(SITE_IDENTIFIER, 'showSerieHosters', sDisplayTitle, sThumb, sDesc, output_parameter_handler)
