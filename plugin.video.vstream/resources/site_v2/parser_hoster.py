...
from resources.site_v2.result_hoster import ResultHoster
...
class ParserHoster(ParserEpisode):
    ...
    def _parse_result(self, elem: Tag, json_data) -> ResultHoster:
        ...
        if 'lang' in json_data:
            hoster_result.set_lang(Parser._read_element_data(elem, json_data['lang']))

        if 'quality' in json_data:
            hoster_result.set_quality(Parser._read_element_data(elem, json_data['quality']))
