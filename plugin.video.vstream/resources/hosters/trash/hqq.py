...
class cHoster(iHoster):
        ...
        if not params.get('return_data', False):
            ...
            try:
                ...
                if e.code == 404:
                    ...
                    if e.code in [
                            300, 302, 303, 307] and params.get(
    ...
    def parseNETUTV(self, url):
        ...
        playerUrl = "http://hqq.tv/player/embed_player.php?vid=%s&autoplay=no" % match.group(
            1)
        print(playerUrl)
        HTTP_HEADER = {
        ...
        print("lalala")
        print(file_vars)
        file_vars = self.getDataBeetwenMarkers(
            data, 'file:', ',', False)[1].strip()
